...
while true do
	...
	if cmd then
		if cmd == "quit" then
			...
			return
		elseif cmd == "1" then 
			send_request("login", {id="123456", password="linhui"})
		elseif cmd == "2" then 
			send_request("login", {id="10086", password="crazy"})
		elseif cmd == "3" then 
			send_request("login", {id="10010", password="3331723"})
		elseif cmd == "4" then 
			send_request("login", {id="misswu", password="misswu"})
		elseif cmd == "5" then 
			send_request("login", {id="jean", password="jean"})
		elseif cmd == "6" then 
			send_request("login", {id="dabiaoge", password="dabiaoge"})
